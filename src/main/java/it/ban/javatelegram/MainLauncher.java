...
import it.ban.javatelegram.storage.ApiStorage;
...
public class MainLauncher {
	public static final int API_ID = 000000; // your api key
	public static final String API_HASH = "XXXXX"; // your api hash
    private static final String PHONE_NUMBER = "+39XXXXXXXX"; // Your phone number
 ...
 // What you want to appear in the "all sessions" screen
  ...
  //  public static TelegramApp application = new TelegramApp(API_ID, API_HASH, MODEL, SYSTEM_VERSION, APP_VERSION, LANG_CODE);
    public static void main(String[] args) {
    	...
    	//IF YOU WANT TO SET A SPECIFIC DATACENTER
    	...
    	TelegramClient client = Kotlogram.getDefaultClient(application, new ApiStorage(), new UpdateCallback() {
